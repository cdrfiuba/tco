...
Para que el microcontrolador pueda llevar la cuenta de los encoders, se conecto la salida de cada uno a pines de interrupción externa INT1 e INT2. De esta forma; cada vez que hay un flanco ascendente en alguna de las interrupciones, se incrementa una variable.
