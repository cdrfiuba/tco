...
Ambos motores tienen un sensor de efecto Hall en el extremo, estos sirven para medir las revoluciones, pudiendo de esta forma, medir con precisión cuanto gira cada rueda.
Las salidas de los encoders, se conectaron a los pines de interrupción externa IN1 e IN2. De esta forma; cada vez que hay un flanco ascendente en alguna de las interrupciones, se incrementa una variable.
